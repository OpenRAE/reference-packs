# Samba Active Directory-compatible domain controller

Reusable samba active directory-compatible domain controller with domain-specific configuration, declared service surfaces, seeded objects, and pack-local integration material.
